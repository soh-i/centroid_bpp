...
def parse_args():
    parser = argparse.ArgumentParser(description="centroid_bppm is tiny script that allow us to base-pair probability each base position from given bppm file. Input bppm file is generated by follwing command: `centroid_fold --posteriors 0.0001  --oposteriors out.bppm --postscript out.ps -o out.out out.fa`")
